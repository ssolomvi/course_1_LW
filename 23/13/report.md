...
Вариант 13. Проверить, является ли двоичное дерево линейным списком вершин.
...
Проверять от корневого элемента дерева, используя постфиксный обход, наличие двух не равных NULL "детей". В случае, если дерево пустое, или потомков не существует, дерево удовлетворяет условиям. В противном случае нет. 
